...
namespace evo
{
	...
	struct Vector2 {
		...
		constexpr static T Dot(const Vector2 l, const Vector2 r) noexcept {
			return l.x * r.x + l.y * r.y;
		}
		constexpr static T Cross(const Vector2 l, const Vector2 r) noexcept {
